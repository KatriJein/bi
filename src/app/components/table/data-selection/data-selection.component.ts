...
import { FilterColumn, TablePageStateService } from '../../../services';
import { MatButtonModule } from '@angular/material/button';
import { MatIconModule } from '@angular/material/icon';
import { MatTooltipModule } from '@angular/material/tooltip';
import { MatDialog } from '@angular/material/dialog';
import { take } from 'rxjs';
import { FilterModalComponent } from '../../chart/filter/filter-modal/filter-modal.component';
...
export class DataSelectionTableComponent {
  ...
  private stateService = inject(TablePageStateService);
  ...
  tableColumns = toSignal(this.stateService.tableColumns$, {
    initialValue: [],
  });
